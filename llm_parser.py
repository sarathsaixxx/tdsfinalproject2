...
When writing to the metadata.txt file, use triple quotes to avoid syntax errors with strings, for example:
with open("{folder}/metadata.txt", "a") as f:
    f.write(\"\"\"
    File: {folder}/data.csv
    Description: This file contains the scraped data.
    \"\"\")
